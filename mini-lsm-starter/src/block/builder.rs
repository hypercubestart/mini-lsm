...
impl BlockBuilder {
    ...
    pub fn add(&mut self, key: KeySlice, value: &[u8]) -> bool {
        ...
        let byte_size_increase = size_u16 + key.key_len() + size_u16 + value.len() + size_u16;
        ...
        if self.is_empty() || new_size <= self.block_size {
            ...
            if self.offsets.is_empty() {
                ...
                let overlap = prefix(self.first_key.key_ref(), key.key_ref());
                self.data.put_u16(overlap as u16);
                let rest_key_len = key.key_len() as u16 - overlap as u16;
